    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p1, "class", "footer-title svelte-16oy944");
    			...
    			attr_dev(p5, "class", "footer-title svelte-16oy944");
    			add_location(p5, file$1, 38, 8, 1076);
    			attr_dev(input, "type", "email");
    			attr_dev(input, "class", "form-control round-border svelte-16oy944");
    			attr_dev(input, "placeholder", "Your Email");
    			add_location(input, file$1, 39, 8, 1136);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-outline-light round-border svelte-16oy944");
    			add_location(button, file$1, 43, 8, 1260);
    			attr_dev(div3, "class", "col-md-4 footer-box svelte-16oy944");
    			add_location(div3, file$1, 37, 6, 1033);
    			attr_dev(div4, "class", "row section-body svelte-16oy944");
